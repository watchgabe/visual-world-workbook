...
export default function ContentOverview() {
  return (
    <ModuleOverview
      ...
      beginLabel="Begin Part 1 — Strategy →"
      roadmap={[
        ...
        { num: '07', slug: 'idea-generation', title: 'Idea Generation', sub: 'Turn one topic into dozens of content ideas' },
        { num: '08', slug: 'storytelling', title: 'Storytelling', sub: 'Capture attention and build belief' },
        { num: '09', slug: 'starter-kit', title: 'Starter Kit', sub: 'The gear that gives you professional results' },
