  ...
  return (
    <ModuleOverview
      ...
      roadmap={[
        ...
        { num: '03', slug: 'batching', title: 'Batching System', sub: 'Protect your maker time and create in bulk' },
        ...
        { num: '06', slug: 'idea-generation', title: 'Idea Generation', sub: 'Turn one topic into dozens of content ideas' },
        { num: '07', slug: 'storytelling', title: 'Storytelling', sub: 'Capture attention and build belief' },
        { num: '08', slug: 'starter-kit', title: 'Starter Kit', sub: 'The gear that gives you professional results' },
        { num: '09', slug: 'cinematic-content', title: 'Cinematic Content', sub: 'Shots, angles, B-roll, and premium visuals' },
      ]}
      footer={
        <div
          style={{
